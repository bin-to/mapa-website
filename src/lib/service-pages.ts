...
export const servicePages: ServicePageContent[] = [
  ...
  },
  {
    ...
    navLabel: "Flachdach",
    metaDescription:
      "Flachdachabdichtung, Sanierung und Reparatur in Rudersberg. Bitumenbahnen, Flüssigabdichtung, Anschlüsse und Entwässerung fachgerecht ausgeführt.",
    heroSubtitle:
      "Abdichtung, Sanierung und Instandsetzung von Flachdächern.",
    intro: [
      "Flachdächer sind bei Wohn- und Gewerbegebäuden weit verbreitet. Ihre Aufgabe ist der zuverlässige Schutz der darunterliegenden Bausubstanz vor Regen, Schnee und stehendem Wasser. Damit das funktioniert, müssen Abdichtung, Gefälle, Entwässerung und Anschlüsse an Dachrändern, Attiken und Durchdringungen zusammenpassen.",
      "Undichtigkeiten fallen oft erst spät auf – zum Beispiel als Feuchteflecken an Decken, Geruchsbildung oder Schäden an der Wärmedämmung. Häufige Ursachen sind verschlissene Abdichtungsbahnen, undichte Anschlüsse, mangelhafte Randausbildungen oder verstopfte Entwässerungselemente.",
      "Vor jeder Maßnahme prüfen wir den vorhandenen Aufbau und den Zustand der Abdichtung. Danach legen wir fest, ob eine punktuelle Reparatur ausreicht oder eine größere Sanierung bzw. Erneuerung erforderlich ist. Je nach Gebäude und Anforderung setzen wir Bitumenbahnen oder Flüssigkunststoff ein.",
      "Wir führen Abdichtungsarbeiten an Bestandsdächern und im Rahmen von Sanierungen aus. Dazu gehören die Vorbereitung des Untergrunds, die fachgerechte Verlegung bzw. Aufbringung der Abdichtung sowie die Ausführung der Anschlüsse und Randbereiche.",
    ],
    detailsTitle: "Was bei der Ausführung wichtig ist",
    details: [
      ...
      "Anschlüsse an Attika, Lichtkuppeln, Dachdurchführungen und angrenzende Bauteile sind häufige Schwachstellen. Sie erfordern saubere Detailausführung und passendes Material, damit die Abdichtung langfristig dicht bleibt.",
      "Nach Abschluss der Arbeiten übergeben wir eine ordentlich ausgeführte Fläche. Auf Wunsch besprechen wir auch, welche Kontrollen und Wartungsmaßnahmen für die spätere Nutzung sinnvoll sind.",
    ],
    scopeTitle: "Leistungen im Überblick",
    scopeItems: [
      "Abdichtung mit Bitumenbahnen, mehrlagig nach Aufbau und Anforderung",
      ...
      "Ausführung von Dachrand- und Attika-Anschlüssen",
      "Abdichtung von Durchdringungen und Anschlussstellen",
      "Prüfung und Instandsetzung der Entwässerung",
      "Punktuelle Reparaturen an bestehenden Abdichtungen",
      "Besichtigung, Zustandsbeurteilung und Angebotserstellung",
    ],
    closing:
      "Flachdachabdichtung ist eine technische Aufgabe, bei der Details den Unterschied machen. Gerne prüfen wir Ihr Dach vor Ort und erläutern Ihnen, welche Maßnahmen in Ihrem Fall erforderlich sind.",
    gallery: [
      {
        imageKey: "flachdachabdichtung",
        caption: "Abdichtung eines Flachdachs mit Bitumenbahnen",
      },
      {
        imageKey: "flachdachabdichtungFluessig",
        caption: "Flüssigabdichtung an Anschluss- und Detailbereichen",
      },
    ],
  },
  {
